<template>
  <div>
    ...
    <div class="get_centered container p-4">
      ...
      <div class="glass-card mx-auto">
        <file-input-form @file-data="submitForm" :filePath="'LD'"></file-input-form>
      </div>
    </div>
  </div>
</template>
...
<script>
import levenshteinDistance from "../../scripts/algorithms/LD.js";
import LDData from "../../scripts/complexities/LD.js";
...
export default {
  ...
  methods: {
    async submitForm(data) {
      ...
      this.result = await levenshteinDistance(
        data.inputa,
        data.inputb
      );
      let end_time = performance.now();
      if (this.result == "") {
        this.result = "No distance Found";
      }
