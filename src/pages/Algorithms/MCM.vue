...
<script>
import MatrixChainMultiplication from "../../scripts/algorithms/MCM.js";
import MCMData from "../../scripts/complexities/MCM.js";
...
export default {
  ...
  methods: {
    async submitForm(data) {
      ...
      this.result = await MatrixChainMultiplication(data.inputa);
