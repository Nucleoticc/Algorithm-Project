<template>
  <div>
    ...
    <div class="get_centered container p-4">
      ...
      <div class="glass-card mx-auto">
        <file-input-form @file-data="submitForm" :filePath="'LCS'"></file-input-form>
      </div>
    </div>
  </div>
</template>
...
<script>
import longestCommonSubsequence from "../../scripts/algorithms/LCS.js";
import LCSData from "../../scripts/complexities/LCS.js";
...
export default {
  ...
  methods: {
    async submitForm(data) {
      ...
      this.result = await longestCommonSubsequence(
        data.inputa,
        data.inputb
      ).join("");
