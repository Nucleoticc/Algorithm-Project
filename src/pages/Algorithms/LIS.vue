  ...
  <div>
    ...
    <div class="get_centered container p-4">
      <div class="glass-card mx-auto">
        <text-input-form :type="1" @input-data="submitForm" :labels="['Input1']"></text-input-form>
      </div>
      <div class="glass-card mx-auto">
        <file-input-form
...
<script>
import dpLongestIncreasingSubsequence from "../../scripts/algorithms/LIS.js";
import LISData from "../../scripts/complexities/LIS.js";
...
export default {
  ...
  methods: {
    async submitForm(data) {
      ...
      this.result = await dpLongestIncreasingSubsequence(data.inputa);
